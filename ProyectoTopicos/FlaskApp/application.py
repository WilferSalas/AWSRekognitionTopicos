...
def home():
    ...
    return render_template_string("""
        ...
        Click <em> en Mis fotos</em> para acceder a las fotos.
        {% else %}
        Click <em>Registrate / Inicia sesion<em> para acceder a esta pagina.
        {% endif %}
        {% endblock %}""")
...
def myphotos():
    "SE requiere iniciar sesion para ver mis fotos"
    ...
    return render_template_string("""
            ...
            {% for photo in photos %}
                ...
                <tr> <td rowspan="4" class="col-md-2 text-center"><img width="150" src="{{photo.signed_url}}" />
                    <a href="{{ url_for('myphotos_delete', object_key=photo.object_key) }}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Borrar</a>
                </td></tr>
                <tr> <th scope="row" class="col-md-2">Descripcion</th> <td>{{photo.description}}</td> </tr>
                <tr> <th scope="row" class="col-md-2">Labels</th> <td>{{photo.labels}}</td> </tr>
                <tr> <th scope="row" class="col-md-2">Subido</th> <td>{{photo.created_datetime}} UTC</td> </tr>
                </table>
